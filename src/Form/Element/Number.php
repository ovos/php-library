 ...
 * "12abc" is a field error (the Validator\Number gate), null and '' pass
 * as "unset", and the storage form is the actual int|float (null/''
 * become null).
 *
...
{
	public const string ERROR_TYPE = Validator\Number::ERROR_NUMBER;
