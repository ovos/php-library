 ...
 * contract: a scalar where an array belongs is a single field error (the
 * Validator\Collection gate), and null passes ("no restriction" is a
 * value for several lists).
 *
 * @author Marcin Gil <mg@ovos.at>
 */
class Collection extends Element
{
	public const string ERROR_TYPE = Validator\Collection::ERROR_COLLECTION;
