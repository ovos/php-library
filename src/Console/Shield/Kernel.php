...
/**
 * ovos/console Shield kernel — zero dependencies, vendor this file.
 *
 *   require_once __DIR__ . '/Shield.php';
 *   use Ovos\Console\Shield\{Kernel, Store, Facts, Consent, Verdict};
 *
 *   $kernel = new Kernel(
 *       'https://console.example',                 // console instance base URL
 ...
 * a console gone silent) lifts by itself; a successful pull — 200 or 304 —
 ...
 *
 * Rules are the console's one grammar for every runtime (dialect re2-2026,
...
final class Ruleset
{
	...
	/** past the ceiling: a console gone silent lifts its shield */
...
final class Kernel
{
	...
	/** the ceiling — a console gone silent this long lifts the shield; a console incident does not disarm the fleet */
	...
	/**
	 * @param string $url the console instance base URL
