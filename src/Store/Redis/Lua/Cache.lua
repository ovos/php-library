...
local function cache_renew_lock(keys, args)
...
redis.register_function('[prefix]cache_renew_lock', cache_renew_lock)

-- Release a lock and publish a notification
local function cache_release_lock_and_publish(keys, args)
	local lock_key = keys[1]
...
redis.register_function('[prefix]cache_release_lock_and_publish', cache_release_lock_and_publish)
